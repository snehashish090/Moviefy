"""
This web app is made by Snehashish Laskar and Ishan Kashyap
This was made from 3rd march till 10th march
Developer contact information:
Snehashish Laskar: github: https://github.com/snehashish090
Ishan Kashyap : github: https://github.com/ishan090
Organization: https://github.com/Snehashish-s-Organization
"""
...
# Defining a function to create the neccessary data file on startup.
...
# defining a function that will check if login password and username is correct or not
...
def remove():
    if request.method == "POST":
        ...
        return "Done!", redirect(url_for("home"))
